...
![MER](src/mer.png "Modelagem de entidade e relacionamento")
...
Para executar o projeto, utilizei a [pyenv](https://github.com/pyenv/pyenv), com a versão 3.11.11 do `python` para o ambiente virtual.
